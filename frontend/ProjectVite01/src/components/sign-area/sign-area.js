...
const SignArea = ({ className }) => {
    ...
    return <div className={(0, classnames_1.default)(sign_area_module_scss_1.default.root, className)}>
            ...
            <div>
                <react_router_dom_1.Routes>
                    <react_router_dom_1.Route path="/signin" element={<form_card_1.FormCard formType="signin" callbackFunction={handleInternalControlClick}/>}/>
                    <react_router_dom_1.Route path="/signup" element={<form_card_1.FormCard formType="signup" callbackFunction={handleInternalControlClick}/>}/>

                    <react_router_dom_1.Route path="/resetpw" element={<form_card_1.FormCard formType="resetpw" callbackFunction={handleInternalControlClick}/>}/>
