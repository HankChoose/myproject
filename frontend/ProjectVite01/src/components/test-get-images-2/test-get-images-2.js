...
const TestGetImages2 = ({ className }) => {
    ...
    return (<div className={(0, classnames_1.default)(test_get_images_2_module_scss_1.default.root, className)}>
            
            <div className={test_get_images_2_module_scss_1.default.thumbnailContainer}>
