...
const Inputpw = ({ className, children }) => {
    ...
    return (<div className={(0, classnames_1.default)(inputpw_module_scss_1.default.root, className)}>
            <input type={showPassword ? 'text' : 'password'} value={password} placeholder={children} onChange={(e) => setPassword(e.target.value)} className={inputpw_module_scss_1.default.Input}/>
