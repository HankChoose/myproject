...
const TestListDataTable = ({ className }) => {
    ...
    return <div className={(0, classnames_1.default)(test_list_data_table_module_scss_1.default.root)}>
                <div>
                    <button className={test_list_data_table_module_scss_1.default.buttonStyle} onClick={toggleViewMode}>
