...
module.exports = async (req, res) => {
  try {
    ...
    const content = [
      ...
      Media.addImage(new Document(), chartBuffer), // 注意这里需要临时 new Document() 来创建图片
    ...
    const doc = new Document({
      properties: {
        creator: "Divorcepath API",
        title: "Divorcepath Legal Report",
        description: "Legal report generated by Divorcepath API",
      },
      sections: [
        {
          children: content,
