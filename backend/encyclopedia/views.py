...
class NewEentryForm(forms.Form):
    newEentryTitle = forms.CharField(
        label="New Entry Title:", widget=forms.TextInput(attrs={'class': 'form-control'}))
    newEentryContent = forms.CharField(
        label="New Entry Content:", widget=forms.Textarea(attrs={'class': 'form-control'}))
...
class EditEentryForm(forms.Form):
    editEentryTitle = forms.CharField(label="Entry Title:", widget=forms.TextInput(
        attrs={'class': 'form-control', 'readonly': 'readonly'}))
    editEentryContent = forms.CharField(
        label="Entry Content:", widget=forms.Textarea(attrs={'class': 'form-control'}))
...
def search(request):
    ...
    if request.META.get('HTTP_X_REQUESTED_WITH') == 'XMLHttpRequest':
        ...
        new_list = [item for item in my_list if any(
            char.lower() in item.lower() for char in search_string)]
        data = new_list
